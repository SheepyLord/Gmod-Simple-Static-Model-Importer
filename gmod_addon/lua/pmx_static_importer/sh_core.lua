...
PMXStaticImporter.Translations = PMXStaticImporter.Translations or {
    en = {
        ...
        tool_desc = "Spawn imported static meshes. LMB: place | RMB: bind to bone | Shift+RMB: edit bound | R+RMB: unbind all | R: remove.",
        tool_help = "Left-click to place. Right-click an entity to bind to its bone. Shift+Right-click to edit bound models. R+Right-click to unbind all. R to remove.",
        ...
        button_apply_to_all = "Apply To All",
        button_refresh_imported_model_list = "Refresh imported model list",
        button_refresh_meshes = "Refresh meshes (rebuild on-map models)",
        button_clear_client_cache = "Clear client mesh/material cache",
        button_remove_all_spawned = "Remove all spawned imported models",
        button_edit_materials = "Edit Materials...",
        button_edit_mesh = "Edit Mesh...",
        mesh_edit_title = "Mesh Editor — %s",
        mesh_edit_title_short = "Mesh Editor",
        mesh_edit_axis = "Axis",
        mesh_edit_min = "Min",
        mesh_edit_max = "Max",
        mesh_edit_save = "Save & Apply",
        mesh_edit_reset = "Reset (Remove Clip)",
        ...
        chat_removed_all_spawned = "Removed all spawned imported models.",
        ...
        bone_title = "Bone Binding — %s",
        bone_count = "Bones (%d)",
        bone_search = "Search bones...",
        bone_name = "Bone Name",
        bone_offset_pos = "Position Offset",
        bone_offset_ang = "Rotation Offset",
        bone_range = "Range (10^x)",
        bone_confirm = "Bind to Bone",
        bone_collision = "Enable collision",
        chat_bone_bound = "Bound to bone '%s'",
        chat_bone_unbound_all = "Removed %d bone-bound model(s) from entity.",
        bone_edit_title = "Edit Bone-Bound Models — %s",
        bone_edit_count = "Attached Models (%d)",
        bone_edit_model = "Model",
    },
    ["zh-CN"] = {
        category_animation = "模型导入器",
        tool_name = "静态模型导入器",
        tool_desc = "生成导入的静态网格。左键：放置 | 右键：绑定到骨骼 | Shift+右键：编辑绑定 | R+右键：解除全部绑定 | R：删除。",
        tool_help = "左键放置。右键点击实体绑定到骨骼。Shift+右键编辑已绑定的模型。R+右键解除全部绑定。R 删除。",
        ...
        button_apply_to_all = "应用到全部",
        button_refresh_imported_model_list = "刷新已导入模型列表",
        button_refresh_meshes = "刷新网格（重建地图上的模型）",
        button_clear_client_cache = "清除客户端网格/材质缓存",
        button_remove_all_spawned = "移除所有已生成的导入模型",
        button_edit_materials = "编辑材质...",
        button_edit_mesh = "编辑网格...",
        mesh_edit_title = "网格编辑器 — %s",
        mesh_edit_title_short = "网格编辑器",
        mesh_edit_axis = "轴",
        mesh_edit_min = "最小值",
        mesh_edit_max = "最大值",
        mesh_edit_save = "保存并应用",
        mesh_edit_reset = "重置（移除裁剪）",
        ...
        chat_removed_all_spawned = "已移除所有已生成的导入模型。",
        ...
        bone_search = "搜索骨骼...",
        bone_name = "骨骼名称",
        bone_offset_pos = "位置偏移",
        bone_offset_ang = "旋转偏移",
        bone_range = "范围 (10^x)",
        bone_confirm = "绑定到骨骼",
        bone_collision = "启用碰撞",
        chat_bone_bound = "已绑定到骨骼 '%s'",
        chat_bone_unbound_all = "已从实体上移除了 %d 个骨骼绑定模型。",
        bone_edit_title = "编辑骨骼绑定模型 — %s",
        bone_edit_count = "已附加模型 (%d)",
        bone_edit_model = "模型",
    },
    fr = {
        category_animation = "Importateur de modèles",
        tool_name = "Importateur de modèles statiques",
        tool_desc = "Fait apparaître des maillages statiques. Gauche : placer | Droit : lier à un os | Shift+Droit : éditer | R+Droit : délier tout | R : supprimer.",
        tool_help = "Clic gauche pour placer. Clic droit sur une entité pour lier à son os. Shift+Clic droit pour éditer. R+Clic droit pour délier tout. R pour supprimer.",
        ...
        button_apply_to_all = "Appliquer à tous",
        button_refresh_imported_model_list = "Actualiser la liste des modèles importés",
        button_refresh_meshes = "Actualiser les maillages (reconstruire les modèles sur la carte)",
        button_clear_client_cache = "Vider le cache client des maillages/matériaux",
        button_remove_all_spawned = "Supprimer tous les modèles importés générés",
        button_edit_materials = "Modifier les matériaux...",
        button_edit_mesh = "Modifier le maillage...",
        mesh_edit_title = "Éditeur de maillage — %s",
        mesh_edit_title_short = "Éditeur de maillage",
        mesh_edit_axis = "Axe",
        mesh_edit_min = "Min",
        mesh_edit_max = "Max",
        mesh_edit_save = "Enregistrer et appliquer",
        mesh_edit_reset = "Réinitialiser (supprimer le découpage)",
        ...
        chat_removed_imported_entity = "L’entité PMX importée a été supprimée.",        chat_removed_all_spawned = "Tous les modèles importés générés ont été supprimés.",
        ...
        bone_title = "Liaison osseuse — %s",
        bone_count = "Os (%d)",
        bone_search = "Rechercher des os...",
        bone_name = "Nom de l'os",
        bone_offset_pos = "Décalage de position",
        bone_offset_ang = "Décalage de rotation",
        bone_range = "Plage (10^x)",
        bone_confirm = "Lier à l'os",
        bone_collision = "Activer les collisions",
        chat_bone_bound = "Lié à l'os '%s'",
        chat_bone_unbound_all = "%d modèle(s) lié(s) aux os retiré(s) de l'entité.",
        bone_edit_title = "Modifier les modèles liés aux os — %s",
        bone_edit_count = "Modèles attachés (%d)",
        bone_edit_model = "Modèle",
    },
    ja = {
        category_animation = "モデルインポーター",
        tool_name = "静的モデルインポーター",
        tool_desc = "インポート済み静的メッシュを生成。左クリック：配置 | 右クリック：ボーンにバインド | Shift+右：編集 | R+右：全解除 | R：削除。",
        tool_help = "左クリックで配置。右クリックでエンティティのボーンにバインド。Shift+右クリックで編集。R+右クリックで全解除。Rで削除。",
        ...
        button_apply_to_all = "すべてに適用",
        button_refresh_imported_model_list = "インポート済みモデル一覧を更新",
        button_refresh_meshes = "メッシュを更新（マップ上のモデルを再構築）",
        button_clear_client_cache = "クライアントのメッシュ/マテリアルキャッシュを消去",
        button_remove_all_spawned = "生成済みの全インポートモデルを削除",
        button_edit_materials = "マテリアルを編集...",
        button_edit_mesh = "メッシュを編集...",
        mesh_edit_title = "メッシュエディター — %s",
        mesh_edit_title_short = "メッシュエディター",
        mesh_edit_axis = "軸",
        mesh_edit_min = "最小値",
        mesh_edit_max = "最大値",
        mesh_edit_save = "保存して適用",
        mesh_edit_reset = "リセット（クリップ解除）",
        ...
        chat_removed_all_spawned = "生成済みの全インポートモデルを削除しました。",
        ...
        bone_title = "ボーンバインド — %s",
        bone_count = "ボーン (%d)",
        bone_search = "ボーンを検索...",
        bone_name = "ボーン名",
        bone_offset_pos = "位置オフセット",
        bone_offset_ang = "回転オフセット",
        bone_range = "範囲 (10^x)",
        bone_confirm = "ボーンにバインド",
        bone_collision = "コリジョンを有効化",
        chat_bone_bound = "ボーン '%s' にバインドしました",
        chat_bone_unbound_all = "エンティティから %d 個のボーンバインドモデルを削除しました。",
        bone_edit_title = "ボーンバインドモデルを編集 — %s",
        bone_edit_count = "アタッチ済みモデル (%d)",
        bone_edit_model = "モデル",
    },
    ko = {
        category_animation = "모델 임포터",
        tool_name = "정적 모델 임포터",
        tool_desc = "가져온 정적 메시를 생성합니다. 좌클릭: 배치 | 우클릭: 뼈에 바인드 | Shift+우클릭: 편집 | R+우클릭: 전체 해제 | R: 제거.",
        tool_help = "좌클릭으로 배치. 우클릭으로 엔티티 뼈에 바인드. Shift+우클릭으로 편집. R+우클릭으로 전체 해제. R로 제거.",
        ...
        button_apply_to_all = "모두에 적용",
        button_refresh_imported_model_list = "가져온 모델 목록 새로고침",
        button_refresh_meshes = "메시 새로고침 (맵 위의 모델 재구축)",
        button_clear_client_cache = "클라이언트 메시/재질 캐시 비우기",
        button_remove_all_spawned = "생성된 모든 가져온 모델 제거",
        button_edit_materials = "재질 편집...",
        button_edit_mesh = "메시 편집...",
        mesh_edit_title = "메시 편집기 — %s",
        mesh_edit_title_short = "메시 편집기",
        mesh_edit_axis = "축",
        mesh_edit_min = "최소값",
        mesh_edit_max = "최대값",
        mesh_edit_save = "저장 및 적용",
        mesh_edit_reset = "초기화 (클립 제거)",
        ...
        chat_removed_all_spawned = "생성된 모든 가져온 모델을 제거했습니다.",
        ...
        bone_search = "본 검색...",
        bone_name = "본 이름",
        bone_offset_pos = "위치 오프셋",
        bone_offset_ang = "회전 오프셋",
        bone_range = "범위 (10^x)",
        bone_confirm = "본에 바인드",
        bone_collision = "충돌 활성화",
        chat_bone_bound = "본 '%s'에 바인드됨",
        chat_bone_unbound_all = "엔티티에서 본 바인드된 모델 %d개를 제거했습니다.",
        bone_edit_title = "본 바인드 모델 편집 — %s",
        bone_edit_count = "부착된 모델 (%d)",
        bone_edit_model = "모델",
    },
    ru = {
        category_animation = "Импортёр моделей",
        tool_name = "Импортёр статических моделей",
        tool_desc = "Создаёт импортированные статические меши. ЛКМ: разместить | ПКМ: привязать к кости | Shift+ПКМ: редактировать | R+ПКМ: отвязать всё | R: удалить.",
        tool_help = "ЛКМ — разместить. ПКМ по сущности — привязать к кости. Shift+ПКМ — редактировать. R+ПКМ — отвязать всё. R — удалить.",
        ...
        button_apply_to_all = "Применить ко всем",
        button_refresh_imported_model_list = "Обновить список импортированных моделей",
        button_refresh_meshes = "Обновить меши (перестроить модели на карте)",
        button_clear_client_cache = "Очистить клиентский кэш мешей/материалов",
        button_remove_all_spawned = "Удалить все созданные импортированные модели",
        button_edit_materials = "Редактировать материалы...",
        button_edit_mesh = "Редактировать меш...",
        mesh_edit_title = "Редактор меша — %s",
        mesh_edit_title_short = "Редактор меша",
        mesh_edit_axis = "Ось",
        mesh_edit_min = "Мин",
        mesh_edit_max = "Макс",
        mesh_edit_save = "Сохранить и применить",
        mesh_edit_reset = "Сбросить (удалить обрезку)",
        ...
        chat_removed_all_spawned = "Все созданные импортированные модели удалены.",
        ...
        bone_title = "Привязка к кости — %s",
        bone_count = "Кости (%d)",
        bone_search = "Поиск костей...",
        bone_name = "Название кости",
        bone_offset_pos = "Смещение позиции",
        bone_offset_ang = "Смещение вращения",
        bone_range = "Диапазон (10^x)",
        bone_confirm = "Привязать к кости",
        bone_collision = "Включить коллизию",
        chat_bone_bound = "Привязано к кости '%s'",
        chat_bone_unbound_all = "Удалено %d привязанных к костям моделей с сущности.",
        bone_edit_title = "Редактирование моделей на костях — %s",
        bone_edit_count = "Прикреплённые модели (%d)",
        bone_edit_model = "Модель",
    },
}
