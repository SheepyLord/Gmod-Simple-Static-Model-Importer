...
binaries = [('C:\\ProgramData\\miniforge3\\Library\\bin\\tcl86t.dll', '.'), ('C:\\ProgramData\\miniforge3\\Library\\bin\\tk86t.dll', '.')]
hiddenimports = ['tkinter', '_tkinter', 'PIL.ImageTk', 'trimesh']
